...
//using UnityEditor; // Be sure to comment out the editor includes as trhey do not work at runtime
using UnityEngine;
...
namespace UIToolkitExamples {
    /// <summary>
    /// This was taken from the Unity documentation, BUT in the docs its an editor window.
    /// making it into a Runtime window is super easy and i have marked the areas i changed...<br/><br/>
    /// you can compair the original here: https://docs.unity3d.com/Manual/UIE-create-list-view-complex.html
    /// </summary>
    public class ListViewExample: VisualElement { // Changed from EditorWindow to a VisualElement
        ...
        /* Removed the editor only window calls and moved creation to a seperate Monobehavior
        ...
        */
        ...
        // Change the original editor only functions to the onenable
        private VisualElement rootVisualElement;


        public ListViewExample()
        {
            // reroute the previous calls into this items content container
            // Thats it... now this old Editor only window can now be used at runtime.
            // Note: make sure you have removed all using UnityEditor calls
            rootVisualElement = this.contentContainer;
